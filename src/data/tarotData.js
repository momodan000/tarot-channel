...
// GitHub Raw图片URL生成器
const GITHUB_BASE = "https://raw.githubusercontent.com/momodan000/tarot-channel/main/public/cards";
...
function buildWikiUrl(path, id, name) {
  // 生成GitHub raw URL，文件名格式: {id:02d}_{牌名}.jpg
  const cardNames = [
    "愚者", "魔术师", "女祭司", "女皇", "皇帝", "教皇", "恋人", "战车", "力量", "隐士",
    "命运之轮", "正义", "吊人", "死神", "节制", "恶魔", "塔", "星星", "月亮", "太阳",
    "审判", "世界",
    "圣杯A", "圣杯2", "圣杯3", "圣杯4", "圣杯5", "圣杯6", "圣杯7", "圣杯8", "圣杯9", "圣杯10",
    "圣杯侍者", "圣杯骑士", "圣杯皇后", "圣杯国王",
    "星币A", "星币2", "星币3", "星币4", "星币5", "星币6", "星币7", "星币8", "星币9", "星币10",
    "星币侍者", "星币骑士", "星币皇后", "星币国王",
    "宝剑A", "宝剑2", "宝剑3", "宝剑4", "宝剑5", "宝剑6", "宝剑7", "宝剑8", "宝剑9", "宝剑10",
    "宝剑侍者", "宝剑骑士", "宝剑皇后", "宝剑国王",
    "权杖A", "权杖2", "权杖3", "权杖4", "权杖5", "权杖6", "权杖7", "权杖8", "权杖9", "权杖10",
    "权杖侍者", "权杖骑士", "权杖皇后", "权杖国王"
  ];
  const cardName = cardNames[id] || `card_${id}`;
  const filename = `${String(id).padStart(2, '0')}_${cardName}.jpg`;
...
export const tarotCards = [
  ...
  { id: 2, name: "女祭司", nameEn: "The High Priestess", suit: "major",
    ...
    image: buildWikiUrl(majorImages[2], id, name) },
  ...
  { id: 21, name: "世界", nameEn: "The World", suit: "major",
    ...
    image: buildWikiUrl(majorImages[21], id, name) },
  ...
  { id: 22, name: "圣杯 Ace", nameEn: "Ace of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[0], id, name) },
  { id: 23, name: "圣杯二", nameEn: "Two of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[1], id, name) },
  { id: 24, name: "圣杯三", nameEn: "Three of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[2], id, name) },
  { id: 25, name: "圣杯四", nameEn: "Four of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[3], id, name) },
  { id: 26, name: "圣杯五", nameEn: "Five of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[4], id, name) },
  { id: 27, name: "圣杯六", nameEn: "Six of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[5], id, name) },
  { id: 28, name: "圣杯七", nameEn: "Seven of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[6], id, name) },
  { id: 29, name: "圣杯八", nameEn: "Eight of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[7], id, name) },
  { id: 30, name: "圣杯九", nameEn: "Nine of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[8], id, name) },
  { id: 31, name: "圣杯十", nameEn: "Ten of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[9], id, name) },
  { id: 32, name: "圣杯侍卫", nameEn: "Page of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[10], id, name) },
  { id: 33, name: "圣杯骑士", nameEn: "Knight of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[11], id, name) },
  { id: 34, name: "圣杯皇后", nameEn: "Queen of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[12], id, name) },
  { id: 35, name: "圣杯国王", nameEn: "King of Cups", suit: "cups",
    ...
    image: buildWikiUrl(minorPaths.cups[13], id, name) },
  ...
  { id: 36, name: "星币 Ace", nameEn: "Ace of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[0], id, name) },
  { id: 37, name: "星币二", nameEn: "Two of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[1], id, name) },
  { id: 38, name: "星币三", nameEn: "Three of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[2], id, name) },
  { id: 39, name: "星币四", nameEn: "Four of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[3], id, name) },
  { id: 40, name: "星币五", nameEn: "Five of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[4], id, name) },
  { id: 41, name: "星币六", nameEn: "Six of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[5], id, name) },
  { id: 42, name: "星币七", nameEn: "Seven of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[6], id, name) },
  { id: 43, name: "星币八", nameEn: "Eight of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[7], id, name) },
  { id: 44, name: "星币九", nameEn: "Nine of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[8], id, name) },
  { id: 45, name: "星币十", nameEn: "Ten of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[9], id, name) },
  { id: 46, name: "星币侍卫", nameEn: "Page of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[10], id, name) },
  { id: 47, name: "星币骑士", nameEn: "Knight of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[11], id, name) },
  { id: 48, name: "星币皇后", nameEn: "Queen of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[12], id, name) },
  { id: 49, name: "星币国王", nameEn: "King of Pentacles", suit: "pentacles",
    ...
    image: buildWikiUrl(minorPaths.pentacles[13], id, name) },
  ...
  { id: 50, name: "宝剑 Ace", nameEn: "Ace of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[0], id, name) },
  { id: 51, name: "宝剑二", nameEn: "Two of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[1], id, name) },
  { id: 52, name: "宝剑三", nameEn: "Three of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[2], id, name) },
  { id: 53, name: "宝剑四", nameEn: "Four of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[3], id, name) },
  ...
  { id: 56, name: "宝剑七", nameEn: "Seven of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[6], id, name) },
  { id: 57, name: "宝剑八", nameEn: "Eight of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[7], id, name) },
  { id: 58, name: "宝剑九", nameEn: "Nine of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[8], id, name) },
  { id: 59, name: "宝剑十", nameEn: "Ten of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[9], id, name) },
  { id: 60, name: "宝剑侍卫", nameEn: "Page of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[10], id, name) },
  { id: 61, name: "宝剑骑士", nameEn: "Knight of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[11], id, name) },
  { id: 62, name: "宝剑皇后", nameEn: "Queen of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[12], id, name) },
  { id: 63, name: "宝剑国王", nameEn: "King of Swords", suit: "swords",
    ...
    image: buildWikiUrl(minorPaths.swords[13], id, name) },
  ...
  { id: 64, name: "权杖 Ace", nameEn: "Ace of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[0], id, name) },
  { id: 65, name: "权杖二", nameEn: "Two of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[1], id, name) },
  { id: 66, name: "权杖三", nameEn: "Three of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[2], id, name) },
  { id: 67, name: "权杖四", nameEn: "Four of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[3], id, name) },
  { id: 68, name: "权杖五", nameEn: "Five of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[4], id, name) },
  { id: 69, name: "权杖六", nameEn: "Six of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[5], id, name) },
  { id: 70, name: "权杖七", nameEn: "Seven of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[6], id, name) },
  { id: 71, name: "权杖八", nameEn: "Eight of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[7], id, name) },
  { id: 72, name: "权杖九", nameEn: "Nine of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[8], id, name) },
  { id: 73, name: "权杖十", nameEn: "Ten of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[9], id, name) },
  { id: 74, name: "权杖侍卫", nameEn: "Page of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[10], id, name) },
  { id: 75, name: "权杖骑士", nameEn: "Knight of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[11], id, name) },
  { id: 76, name: "权杖皇后", nameEn: "Queen of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[12], id, name) },
  { id: 77, name: "权杖国王", nameEn: "King of Wands", suit: "wands",
    ...
    image: buildWikiUrl(minorPaths.wands[13], id, name) },
];
